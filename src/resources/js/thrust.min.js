  ...
  t.ui = t.ui || {}, t.extend(t.ui, {
    ...
    plugin: {
      ...
      call: function call(t, e, n) {
        var i,
            r = t.plugins[e];
        if (r && t.element[0].parentNode && 11 !== t.element[0].parentNode.nodeType) for (i = 0; r.length > i; i++) {
...
(function (t, e) {
  ...
  t.cleanData = function (e) {
    ...
    _createWidget: function _createWidget(e, n) {
...
function addListeners() {
  $('[data-post]').on('click', function (e) {
    e.preventDefault();
    return $('<form action="' + $(this).attr('href') + "\" method=\"POST\"><input type=\"hidden\" name=\"_token\" value=\"".concat(csrf_token, "\"></form>")).appendTo('body').submit();
  });
  $('[data-delete]').on('click', function (e) {
    ...
    if (dataDelete.indexOf("ajax") !== -1) {
      e.preventDefault();
      return callAjax($(this).attr('href'), {
        "_method": "delete"
      });
    }
...
function loadPopup(url) {
  $("#popupContent").load(url, function (response, status, xhr) {
    ...
    $(".loadingImage").hide();
    if (status == "error") $("#popupContent").html("Error while loading: " + xhr.status + " " + xhr.statusText);else setupFormLoadingImage();
  });
}
...
function hidePopup() {
  if (didPopupReload) return location.reload();
  $('#popup').popup('hide');
}
...
function callAjax(url, data) {
  ...
  $.post(url, data, function () {}).done(function (data) {
    if (data) {
      $(".loadingImage").hide();
      showMessage("done");
      reloadPopup();
...
function saveOrder(model, startAt) {
  $(".loadingImage").show();
  postSaveOrder(window.location.origin + '/thrust/' + model + '/updateOrder?startAt=' + startAt, ".sortable");
}

function saveChildOrder(model, id, field) {
  $(".loadingImage").show();
  postSaveOrder(window.location.origin + '/thrust/' + model + '/' + id + '/belongsToMany/' + field + '/updateOrder', '.sortableChild');
}

function postSaveOrder(url, classToSerialize) {
  var serialized = $(classToSerialize).sortable('serialize');
  serialized = serialized + "&_token=" + csrf_token;
  console.log("Url:" + url);
  console.log("Serialized:" + serialized);
  $.post(url, serialized, function () {}).done(function (data) {
    if (data) {
      $(".loadingImage").hide();
      console.log(data);
...
function dropdownCloseEvent() {
  $(document).mouseup(function (e) {
    ...
    var nonSelectedOptions = $('#nonSelectedOptions');

    if (!selectedOptions.is(e.target) && selectedOptions.has(e.target).length === 0 && !nonSelectedOptions.is(e.target) && nonSelectedOptions.has(e.target).length === 0) {
...
function clickToAddOptionEvent() {
  $(document).on("click", '.nonSelectedOption', function () {
    var nonSelectedOptionId = this.id;
    var selectedOptionId = nonSelectedOptionId.replace('nonS', 's');
...
function clickToRemoveEvent() {
  $(document).on("click", '#rmOpt', function () {
    var selectedOptionId = $(this).parent().attr("id");
    var nOptId = selectedOptionId.replace('s', 'nonS');
    var optTxt = $(this).closest("span").text();
...
(function (a, f) {
  var c = a.document,
      h = a.location,
      k = a.escape("scrollPosition|" + h.pathname + h.search);

  a.loadScroll = function () {
    var e;

    try {
      e = (localStorage.getItem(k) || "").split("|");
    } catch (g) {
      for (var d = c.cookie.split(";"), b = d.length - 1; 0 <= b && !e; b--) {
        var f = d[b].split("=");
        f[0] == k && (e = a.unescape(f[1]).split("|"));
      }
    }
    ...
    for (d = e.length - 1; 0 <= d; d--) {
      ...
      try {
        if ("" == b[0]) a.scrollTo(b[1], b[2]);else if (b[0]) {
          var h = c.getElementById(b[0]);
          h.scrollLeft = b[1];
          h.scrollTop = b[2];
        }
      } catch (l) {}
  ...
  a.saveScroll = function () {
    var e = [],
        g,
        d;
    a.pageXOffset !== f ? (g = a.pageXOffset, d = a.pageYOffset) : c.documentElement && c.documentElement.scrollLeft !== f ? (g = c.documentElement.scrollLeft, d = c.documentElement.scrollTop) : (g = c.body.scrollLeft, d = c.body.scrollTop);
    (g || d) && e.push(["", g, d].join());
    g = c.all || c.getElementsByTagName("*");

    for (d = 0; d < g.length; d++) {
      var b = g[d];
      b.id && (b.scrollLeft || b.scrollTop) && e.push([b.id, b.scrollLeft, b.scrollTop].join());
    }

    try {
      localStorage.setItem(k, e.join("|"));
    } catch (h) {
      c.cookie = k + "=" + e.join("|") + ";";
    }
  };
...
(function (a) {
  var f, c;
  a.attachEvent ? (f = a.attachEvent, c = "on") : (f = a.addEventListener, c = "");
  f(c + "load", a.loadScroll, !1);
  f(c + "unload", a.saveScroll, !1);
})(window); //ASP.NET
...
setTimeout(function () {
  if ("undefined" != typeof Sys && "undefined" != typeof Sys.WebForms) {
    ...
    a.add_beginRequest(window.saveScroll);
    a.add_endRequest(window.loadScroll);
  }
}, 0);
/*!  1.10.0 | © Algolia | github.com/algolia/places */

!function (t, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.places = e() : t.places = e();
}(this, function () {
  return function (t) {
    function e(r) {
    ...
    t.exports = function (t, e, i) {
      ...
      var s = t.length;
      if (s === +s) for (var o = 0; o < s; o++) {
        e.call(i, t[o], o, t);
      } else for (var a in t) {
        n.call(t, a) && e.call(i, t[a], a, t);
      }
    };
  }, function (t, e) {
    var n;
    ...
    function r(t, e, n, r) {
      ...
      for (e = e.split(h), n = r ? c(n, r) : n, this._callbacks = this._callbacks || {}; i = e.shift();) {
    ...
    function a(t) {
      ...
      for (t = t.split(h), r = [].slice.call(arguments, 1); (e = t.shift()) && (n = this._callbacks[e]);) {
        i = u(n.sync, this, [e].concat(r)), s = u(n.async, this, [e].concat(r)), i() && l(s);
      }
    ...
    function r(t, e) {
      return function (n, r, s) {
        if ("function" == typeof n && "object" == _typeof(r) || "object" == _typeof(s)) throw new i.AlgoliaSearchError("index.search usage is index.search(query, params, cb)");
        0 === arguments.length || "function" == typeof n ? (s = n, n = "") : 1 !== arguments.length && "function" != typeof r || (s = r, r = void 0), "object" == _typeof(n) && null !== n ? (r = n, n = void 0) : void 0 !== n && null !== n || (n = "");
        var o = "";
    ...
    function s(t) {
      var e = t.algoliasearch,
        ...
        return t;
          ...
          A = t.onError,
          E = void 0 === A ? function (t) {
        throw t;
      } : A,
          T = t.onRateLimitReached,
          O = t.type,
      ...
      return b && navigator.geolocation.watchPosition(function (t) {
        ...
        return k.search(y(o({}, I, (n = {}, i(n, N ? "aroundLatLng" : void 0, N), i(n, "query", t), n)))).then(function (e) {
          ...
          if (429 === t.statusCode) return void T();
          E(t);
        });
      };
    }
    ...
    function i(t) {
      ...
      var l = new a["default"](),
        ...
        hint: !1,
        cssClasses: {
          root: "algolia-places" + (!1 === n ? "-nostyle" : ""),
          prefix: p
        },
        debug: !1
      }, o),
    ...
    function r(t, e, r) {
      ...
      if (this._checkAppIdData(), r.hosts) a(r.hosts) ? (this.hosts.read = o(r.hosts), this.hosts.write = o(r.hosts)) : (this.hosts.read = o(r.hosts.read), this.hosts.write = o(r.hosts.write));else {
        var p = c(this._shuffleResult, function (e) {
          return t + "-" + e + ".algolianet.com";
        }),
            f = (!1 === r.dsn ? "" : "-dsn") + ".algolia.net";
    ...
    function o(t) {
      for (var e, n, r = t.length; 0 !== r;) {
        n = Math.floor(Math.random() * r), r -= 1, e = t[r], t[r] = t[n], t[n] = e;
      }
    ...
    r.prototype.initIndex = function (t) {
      ...
      return !1 !== t.withApiKey && (i["x-algolia-api-key"] = this.apiKey), this.userToken && (i["x-algolia-usertoken"] = this.userToken), this.securityTags && (i["x-algolia-tagfilters"] = this.securityTags), e(this.extraHeaders, function (t, e) {
        i[e] = t;
    ...
    t.exports = function t(e) {
      ...
      return r(n, function (n) {
        for (var r in n) {
          n.hasOwnProperty(r) && ("object" == _typeof(e[r]) && "object" == _typeof(n[r]) ? e[r] = t({}, e[r], n[r]) : void 0 !== n[r] && (e[r] = n[r]));
        }
      }), e;
    };
  }, function (t, e, n) {
    function r(t) {
      return function (e, r, s) {
        var o = n(2);
        s = s && o(s) || {}, s.hosts = s.hosts || ["places-dsn.algolia.net", "places-1.algolianet.com", "places-2.algolianet.com", "places-3.algolianet.com"], 0 !== arguments.length && "object" != _typeof(e) && void 0 !== e || (e = "", r = "", s._allowEmptyCredentials = !0);
        var a = t(e, r, s),
    ...
    (function (e) {
      ...
      var a,
          u = n(8)("algoliasearch:src/hostIndexState.js"),
    ...
    r.extractDatasetName = function (t) {
      ...
      _render: function _render(t, e) {
        ...
        function r() {
          function t(t) {
            var e,
                n = p.suggestion.replace("%PREFIX%", s.cssClasses.prefix).replace("%SUGGESTION%", s.cssClasses.suggestion);
      ...
      update: function update(t) {
        ...
        if (this.query = t, this.canceled = !1, this.shouldFetchFromCache(t)) e.apply(this, [this.cachedSuggestions].concat(this.cachedRenderExtraArgs));else {
          ...
          if (this.debounce) {
            ...
            clearTimeout(this.debounceTimeout), this.debounceTimeout = setTimeout(i, this.debounce);
          } else r();
        }
      },
    ...
    u.mixin(r.prototype, {
      ...
      _select: function _select(t) {
        void 0 !== t.value && this.input.setQuery(t.value), this.clearOnSelected ? this.setVal("") : this.input.setInputValue(t.value, !0), this._setLanguageDirection(), !1 === this.eventBus.trigger("selected", t.raw, t.datasetName).isDefaultPrevented() && (this.dropdown.close(), u.defer(u.bind(this.dropdown.empty, this.dropdown)));
      },
      open: function open() {
        if (!this.isActivated) {
    ...
    !function (e, n) {
      t.exports = function (t) {
        var e = function () {
          ...
          function g(t, e, n) {
            for (S in e) {
              n && (o(e[S]) || tt(e[S])) ? (o(e[S]) && !o(t[S]) && (t[S] = {}), tt(e[S]) && !tt(t[S]) && (t[S] = []), g(t[S], e[S], n)) : e[S] !== C && (t[S] = e[S]);
            }
          }
          ...
          return G.matches = function (t, e) {
            ...
            var r,
                i = t.parentNode,
                s = !i;
            return s && (i = Z).appendChild(t), r = ~G.qsa(i, e).indexOf(t), s && Z.removeChild(t), r;
          }, T = function T(t) {
            ...
            var r, i, s;
            return M.test(t) && (r = A(j.createElement(RegExp.$1))), r || (t.replace && (t = t.replace(q, "<$1></$2>")), e === C && (e = $.test(t) && RegExp.$1), e in J || (e = "*"), s = J[e], s.innerHTML = "" + t, r = A.each(L.call(s.childNodes), function () {
              s.removeChild(this);
            ...
            if (!t) return G.Z();
            if ("string" == typeof t) {
              if (t = t.trim(), "<" == t[0] && $.test(t)) r = G.fragment(t, RegExp.$1, e), t = null;else {
              ...
              if (G.isZ(t)) return t;
              if (tt(t)) r = u(t);else if (s(t)) r = [t], t = null;else if ($.test(t)) r = G.fragment(t.trim(), RegExp.$1, e), t = null;else {
                if (e !== C) return A(e).find(t);
                r = G.qsa(j, t);
              }
            }
            ...
            return !1;
          }, A.type = e, A.isFunction = n, A.isWindow = r, A.isArray = tt, A.isPlainObject = o, A.isEmptyObject = function (t) {
            var e;
            ...
            var n,
                ...
                i,
                s = [];
            if (a(t)) for (r = 0; r < t.length; r++) {
              null != (n = e(t[r], r)) && s.push(n);
            } else for (i in t) {
            ...
            ready: function ready(t) {
              return K.test(j.readyState) && j.body ? t(A) : j.addEventListener("DOMContentLoaded", function () {
                t(A);
              }, !1), this;
            },
            get: function get(t) {
            ...
            find: function find(t) {
              var e = this;
              return t ? "object" == _typeof(t) ? A(t).filter(function () {
                var t = this;
            ...
            closest: function closest(t, e) {
              var n = [],
                  r = "object" == _typeof(t) && A(t);
              return this.each(function (s, o) {
                for (; o && !(r ? r.indexOf(o) >= 0 : G.matches(o, t));) {
                  o = o !== e && !i(o) && o.parentNode;
                }
            ...
            attr: function attr(t, e) {
              ...
              return "string" != typeof t || 1 in arguments ? this.each(function (n) {
                if (1 === this.nodeType) if (s(t)) for (S in t) {
                  w(this, S, t[S]);
            ...
            css: function css(t, n) {
              if (arguments.length < 2) {
                ...
                if (tt(t)) {
                  ...
                  return A.each(t, function (t, e) {
                    i[e] = r.style[T(e)] || s.getPropertyValue(e);
                  }), i;
                }
              }
              ...
              if ("string" == e(t)) n || 0 === n ? o = l(t) + ":" + p(t, n) : this.each(function () {
                ...
                t[S] || 0 === t[S] ? o += l(S) + ":" + p(S, t[S]) + ";" : this.each(function () {
              ...
              return t ? this.each(function (e) {
                if ("className" in this) {
                  ...
                  y(this, t, e, n).split(/\s+/g).forEach(function (t) {
                    A(this).hasClass(t) || E.push(t);
                  }, this), E.length && b(this, n + (n ? " " : "") + E.join(" "));
                }
              }) : this;
            },
            removeClass: function removeClass(t) {
              return this.each(function (e) {
                if ("className" in this) {
                  ...
                  E = b(this), y(this, t, e, E).split(/\s+/g).forEach(function (t) {
                    E = E.replace(h(t), " ");
                  }), b(this, E.trim());
                }
              });
            ...
            offsetParent: function offsetParent() {
              return this.map(function () {
                for (var t = this.offsetParent || j.body; t && !H.test(t.nodeName) && "static" == A(t).css("position");) {
                  t = t.offsetParent;
                }
            ...
            A.fn[n] = function () {
              var n,
                  s,
                  o = A.map(arguments, function (t) {
                var r = [];
                return n = e(t), "array" == n ? (t.forEach(function (t) {
                  return t.nodeType !== C ? r.push(t) : A.zepto.isZ(t) ? r = r.concat(t.get()) : void (r = r.concat(G.fragment(t)));
              ...
              return o.length < 1 ? this : this.each(function (e, n) {
                ...
                o.forEach(function (e) {
                  if (a) e = e.cloneNode(!0);else if (!s) return A(e).remove();
          ...
          }), G.Z.prototype = m.prototype = A.fn, G.uniq = O, G.deserializeValue = _, A.zepto = G, A;
        }();
        ...
        return function (e) {
          ...
          function u(t, r, s, u, c, h, f) {
            ...
            r.split(/\s/).forEach(function (n) {
              ...
              var r = i(n);
              r.fn = s, r.sel = c, r.e in _ && (s = function s(t) {
          ...
          e.fn.delegate = function (t, e, n) {
            ...
            return t && !g(t) ? (e.each(t, function (t, e) {
              l.on(t, n, r, e, s);
            }), l) : (g(n) || m(i) || !1 === i || (i = r, r = n, n = p), i !== p && !1 !== r || (i = r, r = p), !1 === i && (i = C), l.each(function (l, p) {
              s && (o = function o(t) {
                return c(p, t.type, i), i.apply(this, arguments);
              }), n && (a = function a(t) {
                var r,
                    s = e(t.target).closest(n, p).get(0);
            ...
            return t && !g(t) ? (e.each(t, function (t, e) {
              i.off(t, n, e);
            }), i) : (g(n) || m(r) || !1 === r || (r = n, n = p), !1 === r && (r = C), i.each(function () {
              c(this, t, r, n);
            }));
    ...
    (function (e, n) {
      !function (e, n) {
        ...
        function v(t, e) {
          e._state === Z ? _(t, e._result) : e._state === Y ? x(t, e._result) : C(e, void 0, function (e) {
            return w(t, e);
          }, function (e) {
            return x(t, e);
          });
        ...
        function y(t, e, n) {
          e.constructor === t.constructor && n === c && e.constructor.resolve === l ? v(t, e) : n === tt ? (x(t, tt.error), tt.error = null) : void 0 === n ? _(t, e) : r(n) ? g(t, e, n) : _(t, e);
        }

        function w(e, n) {
          e === n ? x(e, p()) : t(n) ? y(e, n, d(n)) : _(e, n);
        }
        ...
        function _(t, e) {
          t._state === G && (t._result = e, t._state = Z, 0 !== t._subscribers.length && z(S, t));
        }

        function x(t, e) {
          t._state === G && (t._state = Y, t._result = e, z(b, t));
        }

        function C(t, e, n, r) {
          var i = t._subscribers,
              s = i.length;
          t._onerror = null, i[s] = e, i[s + Z] = n, i[s + Y] = r, 0 === s && t._state && z(S, t);
        }
        ...
        function E(t, e, n, i) {
          ...
          if (s) {
            if (o = A(n, i), o === tt ? (c = !0, a = o.error, o.error = null) : u = !0, e === o) return void x(e, f());
          } else o = i, u = !0;

          e._state !== G || (s && u ? w(e, o) : c ? x(e, a) : t === Z ? _(e, o) : t === Y && x(e, o));
        }
        ...
        function k(t) {
          t[W] = et++, t._state = void 0, t._result = void 0, t._subscribers = [];
        }
        ...
        var W = Math.random().toString(36).substring(2),
          ...
          error: null
            ...
            nt = function () {
          function t(t, e) {
            this._instanceConstructor = t, this.promise = new t(h), this.promise[W] || k(this.promise), M(e) ? (this.length = e.length, this._remaining = e.length, this._result = new Array(this.length), 0 === this.length ? _(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(e), 0 === this._remaining && _(this.promise, this._result))) : x(this.promise, I());
          }

          return t.prototype._enumerate = function (t) {
            for (var e = 0; this._state === G && e < t.length; e++) {
            ...
            if (r === l) {
              var i = d(t);
              if (i === c && t._state !== G) this._settledAt(t._state, e, t._result);else if ("function" != typeof i) this._remaining--, this._result[e] = t;else if (n === rt) {
                var s = new n(h);
            ...
            var r = this.promise;
            r._state === G && (this._remaining--, t === Y ? x(r, n) : this._result[e] = n), 0 === this._remaining && _(r, this._result);
            ...
            rt = function () {
          function t(e) {
            this[W] = O(), this._result = this._state = void 0, this._subscribers = [], h !== e && ("function" != typeof e && P(), this instanceof t ? T(this, e) : R());
          }
        ...
        return rt.prototype.then = c, rt.all = N, rt.race = L, rt.resolve = l, rt.reject = j, rt._setScheduler = i, rt._setAsap = s, rt._asap = z, rt.polyfill = D, rt.Promise = rt, rt;
      });
    }).call(e, n(11), n(4));
  }, function (t, e, n) {
    (function (e) {
    ...
    t.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function (t) {
      ...
      } else if (s(n)) for (a = Array.prototype.slice.call(arguments, 1), c = n.slice(), i = c.length, u = 0; u < i; u++) {
        c[u].apply(this, a);
      }
      return !0;
    ...
    var r = Object.prototype.hasOwnProperty,
      ...
      for (var t in window) {
        try {
          if (!p["$" + t] && r.call(window, t) && null !== window[t] && "object" == _typeof(window[t])) try {
            h(window[t]);
          } catch (t) {
            return !0;
          }
      ...
      var p = c && n;
      if (a && t.length > 0 && !r.call(t, 0)) for (var f = 0; f < t.length; ++f) {
        h.push(String(f));
      }
      if (s && t.length > 0) for (var m = 0; m < t.length; ++m) {
        h.push(String(m));
      } else for (var g in t) {
        p && "prototype" === g || !r.call(t, g) || h.push(String(g));
      }
      if (u) for (var v = d(t), y = 0; y < l.length; ++y) {
        v && "constructor" === l[y] || !r.call(t, l[y]) || h.push(l[y]);
      }
      return h;
    };
    ...
    t.exports = function (t, e, n, a) {
      return e = e || "&", n = n || "=", null === t && (t = void 0), "object" == _typeof(t) ? r(o(t), function (o) {
  ...
  var methods = {
    ...
    _initonce: function _initonce(el) {
      ...
      if (options.type == 'overlay') {
        ...
        $wrapper.css(css); // CSS vertical align helper
      ...
      if (options.action == 'hover') {
        options.keepfocus = false; // Handler: mouseenter, focusin
    ...
    show: function show(el, ordinal) {
      var $el = $(el);
      if ($el.data('popup-visible')) return; // Initialize if not initialized. Required for: $('#popup').popup('show')
      ...
      var $background = $('#' + el.id + '_background'); // `beforeopen` callback event

      callback(el, ordinal, options.beforeopen); // Remember last clicked place

      lastclicked[el.id] = ordinal; // Add popup id to popup stack

      setTimeout(function () {
        stack.push(el.id);
      }, 0); // Calculating maximum z-index
      ...
      if (options.autozindex) {
        ...
        zindexvalues[el.id] = maxzindex; // Add z-index to the background
      ...
      $el.data('popup-visible', true); // Position popup

      methods.reposition(el, ordinal); // Remember which element had focus before opening a popup

      $el.data('focusedelementbeforepopup', document.activeElement); // Handler: Keep focus inside dialog box

      if (options.keepfocus) {
        // Make holder div focusable
        $el.attr('tabindex', -1); // Focus popup or user specified element.
      ...
      $(options.pagecontainer).attr('aria-hidden', true); // Reveal popup content to screen readers
    ...
    hide: function hide(el) {
      ...
      $(options.pagecontainer).attr('aria-hidden', false); // Hide popup content from screen readers

      $el.attr('aria-hidden', true); // `onclose` callback event
    ...
    reposition: function reposition(el, ordinal) {
      ...
      var $wrapper = $('#' + el.id + '_wrapper');
      var $background = $('#' + el.id + '_background');
      ordinal = ordinal || 0; // Tooltip type
      ...
      if (options.type == 'tooltip') {
        ...
        var linkOffset = $tooltipanchor.offset(); // Horizontal position for tooltip
